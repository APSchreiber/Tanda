...
con.execute("CREATE VIEW people_vw AS SELECT people.id, people.first, people.last, people.middle, people.suffix, people.email, people.phone, people.description, people.dob, strftime('%m/%d/%Y', people.dob) as dob_format places.address1, places.address2, places.city, places.state, places.zip, places.country, places.description as placedescription FROM people INNER JOIN places on people.address = places.id)
